class CountAssetDetail {
  String? status;
  String? message;
  CountAsset? data;

  CountAssetDetail({this.status, this.message, this.data});

  CountAssetDetail.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
     data = (json['data'] != null ? new CountAsset.fromJson(json['data']) : null)!;
    // if (json['data'] != null) {
    //   data = <CountAsset>[];
    //   json['data'].forEach((v) {
